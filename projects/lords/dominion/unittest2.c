...
int checkMinion(int choice1, struct gameState *state, int currentPlayer, int bonus){
	...
	int r = playMinion(choice1, state, currentPlayer, &bonus);
    int *ptrR = &r;
...
int main(){
    ...
    checkMinion(choice1, &testState, p, bonus);
