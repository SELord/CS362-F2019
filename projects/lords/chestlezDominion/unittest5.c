...
int main(){
    ...
    r = mineHandler(&testState, choice1, choice2, p);
    ...
    printf("\n\n*****    TEST 5: Positive test case: choice1 == silver, choice2 == gold costing exactly 3 more    *****\n");
    ...
    testState.hand[0][1] = estate;
    testState.hand[0][2] = estate;
    testState.hand[0][3] = silver;
    testState.hand[0][4] = copper;
    handPos = 0;
    choice1 = 3;  //choice1 is a treasure
    choice2 = gold;  //choice2 is a treasure costing allowed
